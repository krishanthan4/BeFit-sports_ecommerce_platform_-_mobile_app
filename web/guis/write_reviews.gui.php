...
<div class="flex flex-row-reverse justify-end items-center">
  ...
  <label for="hs-ratings-readonly-1" class="peer-checked:text-yellow-500/90 text-[#313236] pointer-events-none ">
  ...
  <label for="hs-ratings-readonly-2" class="peer-checked:text-yellow-500/90 text-[#313236] pointer-events-none ">
    <svg class="flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
    </svg>
  </label>
  ...
  <label for="hs-ratings-readonly-3" class="peer-checked:text-yellow-500/90 text-[#313236] pointer-events-none ">
    <svg class="flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
    </svg>
  </label>
  ...
  <label for="hs-ratings-readonly-4" class="peer-checked:text-yellow-500/90 text-[#313236] pointer-events-none ">
    <svg class="flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
    </svg>
  </label>
  ...
  <label for="hs-ratings-readonly-5" class="peer-checked:text-yellow-500/90 text-yellow-500/90 pointer-events-none ">
    <svg class="flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
    </svg>
  </label>
...
<!-- End Rating -->
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                <p class="text-gray-400">Reviewing Product</p>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                          <input disabled id="" type="text" class="border-1 border w-full py-1 px-3 border-[#313236] bg-[#313236] text-gray-400 rounded-md" value="<?= $ReviewProduct["title"]?>">                            
                            </td>                  
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4">
                    <textarea name="" id="textContent" class="w-full order-1 border border-[#313236] bg-[#313236] rounded-md p-3 text-gray-400 outline-none focus:ring-gray-500 focus:ring-1" rows="5" ></textarea>   
                            </td>                  
                        </tr>
                        <!-- More people... -->
                    </tbody>
            ...
            <div class="w-full flex flex-row gap-4 justify-end ">
                    <button onclick="submitReview('<?= $ReviewProduct['id']?>');" class="bg-green-500/90 hover:bg-green-500/70 py-2 px-3 text-[#252629] rounded-md">Submit</button>
                    <button onclick="discard();" class="bg-yellow-500/90 hover:bg-yellow-500/70 py-2 px-3 text-[#252629]  rounded-md">Discard</button>
                </div>
            </div>
