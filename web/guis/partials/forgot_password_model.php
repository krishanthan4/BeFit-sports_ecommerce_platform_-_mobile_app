<main id="fpmodal" role="main" class=" fixed z-50 inset-0 overflow-auto hidden">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-[#303135] rounded-xl shadow-lg p-7">
            <div class="text-center">
                <h1 class="block text-2xl font-bold text-gray-300">Forgot password?</h1>
                <p class="mt-2 text-sm text-gray-400 ">
                    Remember your password?
                    <a class="cursor-pointer font-semibold leading-6 text-indigo-400 hover:text-indigo-500"
                ...
                <div class="grid gap-y-4">
                    <div>
                        <div class="flex gap-2 mt-2">
                            <div class="w-1/2">
                                <label class="block text-sm font-medium leading-6 text-gray-300">New
                                    Password</label>
                                    <div class="mt-2 relative">
    <input id="type_password" type="password"
        placeholder="****" 
        class="block pl-2 w-full rounded-md border-0 py-1.5 text-gray-300 bg-[#4b4d53] ring-0 placeholder:text-gray-400 sm:text-sm sm:leading-6">
    ...
    function togglePassword() {
        ...
        if (passwordInput.type === "password") {
            ...
            hidePasswordIcon.classList.remove("hidden");
                            ...
                            <div class="w-1/2">
                                <label class="block text-sm font-medium leading-6 text-gray-300">Re-type
                                    Password</label>
                                <div class="mt-2 relative">
                    ...
                    <div class="flex gap-2 mt-2">
                        <div class="w-2/4">
                            <button onclick="resetPassword();"
                                class="py-3 px-4 inline-flex justify-center w-full items-center gap-2 rounded-md border border-transparent font-semibold bg-gray-200 text-gray-900 hover:bg-gray-100 focus:outline-none text-sm ">Reset
                                password</button>
                        </div>
                        <div class="w-2/4">
                            <button type="button" onclick="hideForgotPasswordModal();"
                                class="py-3 px-4 inline-flex justify-center w-full items-center gap-2 rounded-md border border-transparent font-semibold bg-gray-500 text-white hover:bg-gray-600 focus:outline-none text-sm 
