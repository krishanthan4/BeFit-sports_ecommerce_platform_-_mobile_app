<main id="verifyCodeModal" role="main" class="fixed z-50 inset-0 overflow-auto hidden">
                <div class="flex items-center justify-center min-h-screen p-4">
                    <div class="bg-[#303135] rounded-sm shadow-lg p-7">
                        <div class="text-center">
                            <h1 class="block text-2xl font-bold text-gray-200">Verify You!</h1>
                        </div>
                        <div class="mt-5">
                                <div class="grid gap-y-4">
                                    <div>
                                        <div class="col-span-12 mt-2 ">
                                            <label
                                                class="block text-sm font-medium leading-6 text-gray-300">Verification
                                                Code</label>
                                            <input type="text" id="verification_code"
                                                class="block pl-2 w-full mt-2 rounded-md border-0 py-1.5 text-gray-200 bg-[#6a6b74] sm:text-sm sm:leading-6">
                                        </div>
                                    ...
                                    <div class="flex gap-2 mt-2">
                                        <div class="w-2/4">
                                            <button
                                            onclick="verifyCode();"
                                                class="py-3 px-4 inline-flex justify-center w-full items-center gap-2 rounded-md border border-transparent font-semibold bg-gray-200 text-gray-800 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">Verify</button>
                                        </div>
                                        <div class="w-2/4">
