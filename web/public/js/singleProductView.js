...
request.open("POST","./processes/singleProductRemoveWishlistProcess.php",true);
request.send(form);
}
...
if(request.responseText=="success"||request.responseText=="successsuccess"){
    ...
    request.open("POST","./processes/singleProductBuyNowProcess.php",true);
    request.send(form);
}
