...
public class GetProvinces_ForCountryService {
    public static void getData(String countryId, GeneralCallBack callback) {
        ...
        Request request = new Request.Builder()
                .url(Config.BACKEND_API_URL + "update_profile/GetProvinces_ForCountryProcess.php")
