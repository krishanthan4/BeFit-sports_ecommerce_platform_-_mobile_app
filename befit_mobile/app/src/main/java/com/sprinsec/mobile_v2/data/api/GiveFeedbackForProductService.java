...
public class GiveFeedbackForProductService {
    public static void Send(Float rating, String product_id, String review, GeneralCallBack callback) {
        ...
        Request request = new Request.Builder()
                .url(Config.BACKEND_API_URL + "giveFeedbackToProductProcess.php")
                .post(body)
                .build();
