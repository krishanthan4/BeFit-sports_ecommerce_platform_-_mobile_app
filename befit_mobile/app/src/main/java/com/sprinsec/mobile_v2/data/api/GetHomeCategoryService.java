...
public class GetHomeCategoryService {
    public static void getHomeCategory(GeneralCallBack callback) {
        OkHttpClient client = HttpClientProvider.getClient();
        Request request = new Request.Builder()
                .url(Config.BACKEND_API_URL + "getHomeCategoryProcess.php")
                .get()
                .build();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull okhttp3.Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    Log.e("GetHomeCategoryService", "Unexpected response: " + response);
            ...
            public void onFailure(@NonNull okhttp3.Call call, @NonNull IOException e) {
                ...
                Log.e("GetHomeCategoryService", "Error: " + e.getMessage());
            }
