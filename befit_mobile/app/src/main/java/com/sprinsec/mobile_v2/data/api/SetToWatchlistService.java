...
public class SetToWatchlistService {
    public static void Send(String product_id, String qty, String watchlistStatus, GeneralCallBack callback) {
        ...
        jsonObject.addProperty("save", watchlistStatus);
        ...
        Request request = new Request.Builder()
                .url(Config.BACKEND_API_URL + "singleProductWishlistProcess.php")
                .post(body)
                .build();
