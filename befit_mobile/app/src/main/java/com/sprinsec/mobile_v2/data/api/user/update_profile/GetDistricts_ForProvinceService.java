...
public class GetDistricts_ForProvinceService {
    public static void getDataData(String provinceId, GeneralCallBack callback) {
        OkHttpClient client = HttpClientProvider.getClient();

        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("province_id", provinceId);
        Request request = new Request.Builder()
                .url(Config.BACKEND_API_URL + "update_profile/GetDistricts_ForProvincesProcess.php")
