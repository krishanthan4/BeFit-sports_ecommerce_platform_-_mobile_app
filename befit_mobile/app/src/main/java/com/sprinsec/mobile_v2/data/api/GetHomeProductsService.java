...
public class GetHomeProductsService {
    public static void getHomeProducts(GeneralCallBack callback) {
        OkHttpClient client = HttpClientProvider.getClient();
        Request request = new Request.Builder()
                .url(Config.BACKEND_API_URL + "getHomeProductsProcess.php")
                .get()
                .build();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull okhttp3.Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    Log.e("GetHomeProductsService", "Unexpected response: " + response);
            ...
            public void onFailure(@NonNull okhttp3.Call call, @NonNull IOException e) {
                ...
                Log.e("GetHomeProductsService", "Error: " + e.getMessage());
            }
