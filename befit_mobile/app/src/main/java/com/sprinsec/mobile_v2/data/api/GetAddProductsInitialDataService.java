...
public class GetAddProductsInitialDataService {
    public static void getData(GeneralCallBack callback) {
        OkHttpClient client = HttpClientProvider.getClient();
        Request request = new Request.Builder()
                .url(Config.BACKEND_API_URL + "getAddProductInitialDataProcess.php")
                .get()
                .build();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull okhttp3.Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    Log.e("getAddProductInitialDataService", "Unexpected response: " + response);
            ...
            public void onFailure(@NonNull okhttp3.Call call, @NonNull IOException e) {
                ...
                Log.e("getAddProductInitialDataService", "Error: " + e.getMessage());
            }
